...
if (contactForm) {
    contactForm.addEventListener('submit', async function(e) {
        ...
        // You must sign up at https://www.emailjs.com/ and replace the following IDs with your own
        const serviceID = 'service_7lz1kqi';
        const templateID = 'template_nalr4vo';
        const userID = 'tadiwasongore@gmail.com';
        ...
        const templateParams = {
            ...
            subject: subject,
            message: message,
            to_email: 'tadiwsongore@gmail.com'
        };
